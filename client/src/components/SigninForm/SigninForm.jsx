        ...
        <main className="d-flex justify-content-center">
            <form action="" method="POST" novalidate className="reg-form">
                ...
                <div className="mb-3">
                    ...
                    <input type="text" name="name" className="form-control placeholder-size" value="" id="name" placeholder="Escribe tu nombre..." />
                </div>
                <div className="mb-3">
                    <label for="email" className="form-label blue-color bold">E-mail</label>
                    <input type="email" name="email" className="form-control placeholder-size" value="" id="email" placeholder="Escribe tu email..." />
                </div>
                <div className="mb-3">
